<template>
  ...
  <div class="table">
    <el-table :data="list" stripe style="width: 100%" height="500px">
    ...
    <el-pagination small background layout="prev,pager,next" @current-change="changePage" :total="config.total" class=" pager mt-4" />
  </div>
